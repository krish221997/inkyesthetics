        ...
        b: {
            render: () => (
                <Text style={{fontFamily: "Poppins-Light", fontSize: "16px"}}><Text
                    ...
                    The question we ask then, is this - Using storytelling as a design tool, can we facilitate ways of
                    exchanging knowledge and make a better experience for not only the consumer but also the artisan?
                </Text>
            )
        }
    }
