export const content = {
  p0: {
    brief: "Fusion is an app that aids creative connect between individuals by helping them meet others around them while they work in a hybrid or remote manner. This app helps them gain inspiration from interesting conversations or learning from people's creative paths."
  },
  p1: {
    brief:
      "The local artisans in Kutch have been creating exceptional art for generations, but their work is " +
    ...
    sajnuben:
      "Sajnuben lives in a village called Kukadsar. She kept migrating until 2009. After which " +
    ...
    judy:
      "Judy Frater is the Founder Director of Somaiya Kala Vidya, an institute of education for artisans. " +
    ...
    testingConcept: {
      t1:
        "As soon as I got an idea, I decided to see if my concept worked. I tried these activities on paper but " +
  ...
  p2: {
    brief:
      "This application is aimed at young and upcoming musicians to empower them to discover and create music." +
  ...
  p3: {
    logo:
      "Chatea is derived from the word ‘chatty’, meaning “readily engaging in an informal talk”. The brand name" +
    ...
    productInfo:
      "While I picked this beverage because I enjoy drinking it, tea is also the perfect metaphor for my" +
  ...
  p4: {
    brief:
      "Deconstruction, as this project treats it, is largely associated with the concept of unfolding, peeling " +
    ...
    hastas: {
      h1:
        "The Devatha Hasthas form 16 of the 3242 shlokas present in the ‘Abhinaya Darpana’. The gods and " +
      ...
      h2:
        "Hasta is the Sanskrit word for hand and Deva means God. So simply translated, the hand gestures which " +
    ...
    aim: {
      ...
      a2:
        "The text explains to the dancer how to denote each god or goddess through the body, " +
      ...
      a3:
        "The visual compositions serve as mnemonic devices, for the names and meanings of the shloka and some " +
